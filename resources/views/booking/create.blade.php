                ...
                <div class="md:col-span-2" style="background:#f0f4ff;border-radius:8px;padding:1rem 1.25rem;border:1.5px solid #dbe4ff;">
                    <label style="display:flex;align-items:flex-start;gap:.75rem;cursor:pointer;">
                        ...
                        <span style="font-size:.85rem;color:#374151;line-height:1.6;">
                            <strong>Optional:</strong> I agree to receive SMS text message lesson reminders from Kristine Skates. Message frequency varies. Message and data rates may apply. Reply STOP to opt out or HELP for help. View our <a href="{{ route('privacy') }}" target="_blank" style="color:#001F5B;text-decoration:underline;">Privacy Policy</a>.
                        </span>
                    </label>
                </div>
