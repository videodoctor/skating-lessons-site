...
<style>
  ...
  @media(max-width:768px) { .hero-inner{padding:0 1.25rem;} .hero-photo-wrap{position:absolute;inset:0;width:100%;display:block;} .hero-photo-wrap video,.hero-photo-wrap img{object-position:center top;opacity:.4;width:100%;} .hero-video-secondary{display:none!important;} .hero-accent{width:100%;clip-path:none;opacity:.6;right:0;left:0;} .hero-photo-wrap::before{display:none;} .hero-photo-wrap::after{background:linear-gradient(90deg,var(--navy) 0%,rgba(0,15,60,.7) 25%,transparent 55%),linear-gradient(to bottom,transparent 40%,var(--navy) 100%);} }
</style>
